...
function Box(options) {
  ...
  /* Initialize object */
  function initialize() {
    if(!self.options.user_name || !self.options.password || !self.options.client_id || !self.options.client_secret
       || !self.options.authorize_url || !self.options.token_url || !self.options.base_url || !self.options.upload_url) {
...
function createSharedLink(values, options, callback) {
  ...
  var header = {
	...
	'Authorization': 'Bearer ' + options.token.access_token
      ...
      method: "PUT",
      json: { "shared_link":{"access": values.access, "permissions": {"can_download": values.can_download}}}
    };
...
function get_content_type(filename) {
  ...
  switch(ext.toLowerCase()) {
    ...
    case "mov": { retval = "video/mov"; break; }
